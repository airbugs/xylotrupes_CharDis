...
cat(c('the number of X. beckeri and X. sumatrensis evolving distinct phenotypes is', BEXBcount));
cat(c('the number of X. pachycera and X. wiltrudi evolving distinct phenotypes is', XWBOcount));
cat(c('the number of X. gideon and X. inarmatus evolving distinct phenotypes is', GIcount));
cat(c('the number of X. florensis and X. tadoana evolving distinct phenotypes is', FFcount));
